...
김성빈은 PM / 개발 리드로 기록하고, 정재훈, 이가은, 차성민, 최승범, 비타는 역할 미정으로 둔다.
...
- Create: `docs/superpowers/specs/2026-05-13-kmu-freshman-ai-design.md`
...
```powershell
gh repo create Sungblab/kmu-freshman-ai --public --source=. --remote=origin --push
```
